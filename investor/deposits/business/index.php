...
if($_SERVER['SERVER_PORT'] != '443') {
    header('Location: https://lider-finance.ru/investor/deposits/business/index.php');
}
        ...
        <div class="row">
        	<div class="col-lg-12">
        		<ul class="breadcrumb">
				  ...
				  <li class="active">Вклад: "Business"</li>
				</ul>
        	</div>
        </div>
		<div class="row">
        	<div class="col-lg-3 text-center">
        	 <ul class="list-group">
				  <a href="#" class="list-group-item active">
				    <h4>Вклад: Business</h4>
				</a>
				  <li class="list-group-item">
				  	126% дохода за вклад на 60 дней
				  </li>
				  <li class="list-group-item">
				  	Инвестиционный лимит 1501 — 5000 USD
				  </li>
				  <li class="list-group-item">
				  	Начисления на внутренний счет  1 раз в сутки <br>(на общую сумму 2.1% от суммы вклада).
				  </li>
			 </ul>
			</div>
			<div class="col-lg-6">
				<fieldset>
        			...
        			<p>Открытие счета производится одновременно с взносом денежных средств. Данный вклад ограничивается лимитом взноса средств.(1501 — 5000 USD)</p>
				    <form class="form-horizontal" action='https://perfectmoney.com/api/step1.asp' method='POST' onkeypress="if(event.keyCode == 13) return false;">
					    <div class="control-group">
						    ...
						    <div class="controls">
						    	<div class="input-group" style="max-width: 200px;">
								  ...
								  <input type="number" name='PAYMENT_AMOUNT' class="form-control" onchange="if ((this.value >= 1501) && (this.value <= 5000)) {getElementById('OutDeposit').disabled = false;}else{getElementById('OutDeposit').disabled = true;}">
                                    <span class="input-group-addon">.00</span>
								</div>
							    <p class="help-block">Сумма взноса должна быть в диапозне от 1501 — 5000 USD.</p>
						    </div>
					    </div>
					    <input type='hidden' name='PAYEE_ACCOUNT' value='U1875378'/>
				        <input type='hidden' name='PAYEE_NAME' value='Lider finance'/>
				        <input type='hidden' name='PAYMENT_ID' value='<?php echo $id."-business"; ?>'/>
				        ...
				        <input type='hidden' name='SUGGESTED_MEMO' value='Взнос средств на открытие вклада Business.'/>
