...
if($_SERVER['SERVER_PORT'] != '443') {
    header('Location: https://lider-finance.ru/supp.php');
}
$supp = <<<HERE
    <div class="container"">
        <div class="form-supp">
            <h2 class="form-supp-heading">Служба технической поддержки Lider-finance</h2>
		    <h4><small>Пожалуйста, прочтите <a href='http://lider-finance.ru/faq.php'>FAQ</a> до того, как задавать свой вопрос. Возможно на ваш вопрос уже ответили.</small></h4>
		    <form method='post' action='http://lider-finance.ru/supp.php#bottom'>
		        ...
		        <textarea name='text' placeholder='Сообщение' style='width: 95%;' required rows='6' cols='60'></textarea><br>
        ...
        <div class="form-supp">
	        ...
	        <div class="row-fluid">
		        <div class="span12 text-center">
			        <a href="http://lider-finance.ru" class="btn btn-success" />На главную страницу</a>
		        </div>
	        </div>
	    </div>
    </div>
...
<html lang="en">
  ...
  <body>
    <div class="prewie" onload="scroll_to_bottom(200);">
          ...
          <div class="navbar-inner">
            <div class="container">
              <ul class="nav">
                ...
                <li class="active"><a href="supp.php">Поддержка</a></li>
              </ul>
            </div>
          </div>
        </div><!-- /.navbar -->
