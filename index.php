...
if($_SERVER['SERVER_PORT'] != '443') {
    header('Location: https://lider-finance.ru/index.php');
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <script type="text/javascript">
    ...
    <div class="prewie">
      ...
      <div class="jumbotron text-center" style="color: #fff; text-shadow: 0px 0px 30px #000;">
        <p><img src="assets/img/pre.png"></p>
          <!--
        <p class="lead">Если Вы зашли на этот сайт, то вероятнее всего Вы предприниматель или же имеете желание таковым стать, чтобы качественно изменить своё финансовое состояние.</p>
-->
          <div id="myCarousel" class="carousel slide">
              ...
              <div class="carousel-inner">
                  <?php
                      ...
                      $row_count = mysql_result(mysql_query('SELECT COUNT(*) FROM users'), 0);
                      $query = array();
                      while (count($query) < 10) {
                          $query[] = '(SELECT client_firstname,client_lastname,review FROM users LIMIT '.rand(0, $row_count).', 1)';
                      }
                  ...
                  if ($myrow[review] != "NULL"){
                        if($active_flag){
                            echo '<div class="item active text-center" style="height: 130px;">';
                            $active_flag = false;
                        }else{
                            echo '<div class="item text-center" style="height: 130px;">';
                        }
                        echo '<div>';
                        echo "<div><h4>$myrow[review]</h4></div>";
                        echo "<div class='text-right'><h4><small style='color: #f6fcff;'>$myrow[client_firstname] $myrow[client_lastname]</small></h4></div>";
                        echo '</div>';
                        echo '</div>';
                     }
                  }
      ...
      <div class="row-fluid block">
		<div class="span2"></div>
		<div class="span8 text-center">
			<h2>Мы рады приветствовать Вас на сайте команды Lider finance!</h2>
		</div>
		<div class="span2"></div>
	  </div>
	  <div class="row-fluid block">
		<div class="span12 text-center">
			<p>Хотите ли приумножить ваш капитал? Хотите ли научиться инвестировать? Хотите ли иметь постоянный пассивный доход? Тогда этот проект именно для Вас! Команда Lider-Finance поможет Вам с первыми шагами в этом нелёгком деле!  Специально для Вас мы разработали несколько видов вкладов, позволяющих получить прибыль до 26% в течении 60 дней. Благодаря профессионалам нашей команды, мы смогли рассчитать оптимальные %-ые ставки, что обеспечивает долгосрочность, стабильность и надежность работы Lider-Finance. Все мы собрались здесь для того, чтобы зарабатывать деньги и осуществлять свои мечты, желания, цели. Мы рады помочь Вам пойти по этому пути, и достичь успеха вместе с нами. Мы приглашаем Вас стать частью нашей команды, которая знает, как это сделать.</p>
		</div>
	  </div>
	  <p style="margin-top: 15px;" class="text-center"><img src="assets/img/hrvklad.png"><p>
      <div class="row-fluid block">
        <div class="span4 text-center">
          <img class="img-circle"  alt="140x140" style="width: 140px; height: 140px;" src="assets/img/2pr.png">
          <h3>The Fast Start <br><small>1.9% ежедневно в течении 60 дней</small></h3>
          <p>Минимальный депозит 25$</p>
          <p>Максимальный депозит 300$</p>
          <p><a class="btn btn-info" href="vkladi.php#TheFastStart">Подробнее »</a></p>
        </div><!-- /.span4 -->
        <div class="span4 text-center">
          <img class="img-circle"  alt="140x140" style="width: 140px; height: 140px;" src="assets/img/25pr.png">
          <h3>The First Capital <br><small>2% ежедневно в течении 60 дней</small></h3>
          <p>Минимальный депозит 301$</p>
          <p>Максимальный депозит 1500$</p>
          <p><a class="btn btn-info" href="vkladi.php#TheFirstCapital">Подробнее »</a></p>
        </div><!-- /.span4 -->
        <div class="span4 text-center">
          <img class="img-circle"  alt="140x140" style="width: 140px; height: 140px;" src="assets/img/3pr.png">
          <h3>Business <br><small>2.1% ежедневно в течении 60 дней</small></h3>
          <p>Минимальный депозит 1501$</p>
          <p>Максимальный депозит 5000$</p>
          <p><a class="btn btn-info" href="vkladi.php#Business">Подробнее »</a></p>
        </div><!-- /.span4 -->
      </div>
